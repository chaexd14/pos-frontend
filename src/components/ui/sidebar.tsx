...
function SidebarProvider({
  ...
  // Auto-close the sidebar when navigating to the POS page (/pos).
  // Use stable setters to avoid this effect re-running when `open` changes
  // (which would immediately re-close after a toggle).
  ...
  React.useEffect(() => {
    ...
    // Only run when pathname or device type changes.
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [pathname, isMobile, setOpenMobile, setOpenProp, _setOpen])
